...
const DEFAULT_DOWNLOAD =
  "https://github.com/zBossPC/IB-Study-App/releases/download/v1.0.12/IBStudy-macos.dmg";
      ...
      <main>
        <section className="hero wrap">
          <div className="hero-badge-row">
            <span className="hero-badge">v1.0.12</span>
            ...
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                ...
                <a
                  ...
                  href={`${repoUrl}/releases/tag/v1.0.12`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Release notes
        ...
        <section id="ai" className="section wrap ai-section">
          <Reveal>
            <div className="section-head">
              <p className="section-kicker">v1.0.12</p>
          ...
          <Reveal>
            <div className="cta-band">
              ...
              <div className="cta-copy">
                ...
                <p>
                  v1.0.12 — download for macOS Tahoe (26+). Questions? Open an issue on GitHub.
                </p>
                <a className="btn btn-primary btn-lg" href={downloadUrl}>
                  Download IBStudy
                </a>
        ...
        <footer className="footer wrap">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <a href={`${repoUrl}/releases/tag/v1.0.12`} target="_blank" rel="noopener noreferrer">
                v1.0.12 notes
              </a>
            </div>
          </div>
