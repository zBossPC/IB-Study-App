...
**Releases / download:** [v1.0.5](https://github.com/zBossPC/IB-Study-App/releases/tag/v1.0.5) — get **`IBStudy-macos.dmg`** (unsigned; open with right-click → Open the first time).
