...
**Releases / download:** [v1.0.0](https://github.com/zBossPC/IB-Study-App/releases/tag/v1.0.0) — get **`IBStudy-macos.dmg`** (unsigned; open with right-click → Open the first time).
