...
**Releases / download:** [v1.0.8](https://github.com/zBossPC/IB-Study-App/releases/tag/v1.0.8) — local AI (Gemma 4 e2b), context-aware tutor, mascot, Ollama CWD fix. Get **`IBStudy-macos.dmg`** (unsigned; right-click → Open the first time).
