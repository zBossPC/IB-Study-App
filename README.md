...
**Releases / download:** [v1.0.5 “Big Dog”](https://github.com/zBossPC/IB-Study-App/releases/tag/v1.0.5) — local AI (Gemma 4 e2b), context-aware tutor, mascot throughout. Get **`IBStudy-macos.dmg`** (unsigned; right-click → Open the first time).
